...
* out3.h5 containing a trained convolution neural network 
* writeup.md summarizing the results
* [https://youtu.be/FZj4Chr1iFw](https://youtu.be/FZj4Chr1iFw) a screen recording shows the final model in action
